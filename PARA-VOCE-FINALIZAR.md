...
Sobraram **9 itens**. Eram 18; fiz 13 no navegador e no banco, e o que verifiquei está no fim
para você não repetir.

Nada aqui é código. Sete dependem de **pessoas**, e dois de **dois minutos seus** clicando num
botão que a automação não consegue clicar.
...
|---|---|---|---|
| 18 | **3 pessoas do distrito** | **022 T027** — mostre a tela de Novidades e peça que digam, com as palavras delas, o que mudou | As três entendem os nove itens **sem explicação** |
...
**Sobre o item 18**, o mais valioso: escrevi os nove textos das Novidades seguindo
