-- Contrato de schema: Rodada de Votação (004)
-- Fonte de verdade que a migration em supabase/migrations/ deve seguir.
-- Depende do schema das features 001 (perfis), 002 (grupos,
-- participacoes_grupo) e 003 (acoes, confirmacoes_acao) já aplicado.
