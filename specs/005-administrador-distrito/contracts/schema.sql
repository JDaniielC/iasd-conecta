-- Contrato de schema: Administrador do Distrito (005)
-- Fonte de verdade que a migration em supabase/migrations/ deve seguir.
-- Depende do schema das features 001 (perfis, igrejas), 002 (grupos) e
-- 004 (acoes com grupo_id, policy acoes_update_criador_ou_dono_grupo) já
-- aplicado.
