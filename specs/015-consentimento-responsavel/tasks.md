...
- [X] T030 **FEITO em 2026-08-10 (item 12).** As duas afirmam, com todas as letras, que o app não verifica a identidade de quem marca a caixa. Sem contradição. Uma assimetria anotada: a caixa nomeia o escopo do que se autoriza (Apelido e Igreja de origem) e a Política descreve o mecanismo sem nomear esse escopo — fecha com uma oração, se quiser. Original: Executar a **Parte 2** de [quickstart.md](./quickstart.md), itens 1 a 15, com o **item 12** conferido lendo o texto inteiro da Política em voz alta ao lado da caixa de autorização — as duas precisam dizer a mesma coisa (FR-010, SC-005)
