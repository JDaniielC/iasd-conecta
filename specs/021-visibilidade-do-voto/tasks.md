...
- [ ] T025 [P] Executar a Parte 3 do [quickstart.md](./quickstart.md). **Parcial**: 3.1 (curl anônimo), 3.4 (texto da Política) e 3.5 (documentos) feitos e verificados. **3.3 (abrir a tela da Rodada e conferir visualmente) NÃO foi feito** — exige rodar o app; o que dá para afirmar é que nenhum widget, provider ou repositório mudou e os 152 testes de unidade e widget seguem verdes. 3.2 (produção) pendente até haver deploy
