...
- [X] T025 **FEITO em 2026-08-10.** 3.1, 3.4 e 3.5 já estavam; **3.3 conferido agora no navegador**: a Rodada mostra "Seu voto" na candidata escolhida, "Votar" na outra, e **nenhuma contagem de votos** na tela. Falta só 3.2 (produção), que depende do deploy. Original: [P] Executar a Parte 3 do [quickstart.md](./quickstart.md). **Parcial**: 3.1 (curl anônimo), 3.4 (texto da Política) e 3.5 (documentos) feitos e verificados. **3.3 (abrir a tela da Rodada e conferir visualmente) NÃO foi feito** — exige rodar o app; o que dá para afirmar é que nenhum widget, provider ou repositório mudou e os 152 testes de unidade e widget seguem verdes. 3.2 (produção) pendente até haver deploy
