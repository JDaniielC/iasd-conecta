...
-- Dupla Missionária (FR-004/FR-005/FR-006/FR-007). SECURITY DEFINER:
-- precisa ler perfis.genero de QUEM JÁ ESTÁ CONFIRMADO (outro Usuário) —
-- RLS de perfis só permite ler a própria linha, então sem isso a leitura
-- cruzada retorna NULL e a validação nunca dispara.
