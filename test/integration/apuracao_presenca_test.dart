...
void main() {
  ...
  setUpAll(() async {
    ...
    await criarPerfilDeTeste(conn, _uidDono, nome: 'Dono ApuracaoPresenca');
    await criarPerfilDeTeste(conn, _uidConfirmado, nome: 'Confirmado ApuracaoPresenca');
    ...
    await conn.execute(
      ...
      parameters: {'grupo': grupoId, 'usuario': _uidConfirmado},
    );
