...
void main() {
  ...
  setUpAll(() async {
    ...
    await criarPerfilDeTeste(conn, _uidAdmin, nome: 'Admin CancelAny');
    await criarPerfilDeTeste(conn, _uidCriador, nome: 'Criador CancelAny');
    await criarPerfilDeTeste(conn, _uidDonoGrupo, nome: 'DonoGrupo CancelAny');
