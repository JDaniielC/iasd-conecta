...
void main() {
  ...
  setUpAll(() async {
    ...
    await criarPerfilDeTeste(conn, _uidDono, nome: 'Dono VotoRevogavel');
    await criarPerfilDeTeste(conn, _uidVotante, nome: 'Votante VotoRevogavel');
    ...
    await conn.execute(
      ...
      parameters: {'grupo': grupoId, 'usuario': _uidVotante},
    );
